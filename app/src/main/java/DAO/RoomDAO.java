...
public class RoomDAO {
    ...
    public void deleteRoom(String roomId) throws DataAccessException {
        try {
            Statement stmt = null;
    ...
    public void clearRooms() throws DataAccessException {
        ...
        try {
            ...
            throw new DataAccessException("Error While Clearing Room Table");
        }
    }
