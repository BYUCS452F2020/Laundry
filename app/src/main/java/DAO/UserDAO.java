...
public class UserDAO {
    ...
    public void updatePreferedRoom(String userId, String roomId) throws DataAccessException {
        String sql = String.format("UPDATE User set PreferredRoomID=%s WHERE UserID=%s",
                roomId, userId);
        try {
            Statement stmt = null;
            stmt = connection.createStatement();
            ...
            throw new DataAccessException("Error while setting preferred room");
        }
    }
    ...
    public void clearUsers() throws DataAccessException {
        ...
        try {
            ...
            throw new DataAccessException("Error while clearing Users");
        }
    }
}
